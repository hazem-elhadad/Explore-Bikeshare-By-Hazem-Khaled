...
def get_filters():
    ...
    while city != 'chicago' and city!= 'new york city' and city!= 'washington' :
      city = (input('Which City do you want get data about: , (chicago, new york city, washington)')).lower()
    ask_user = input('What basis fo you want to filter on? (month , day ,both , none')
    ...
    # get user input for day of week (all, monday, tuesday, ... sunday)
      ...
      month = None
      day = (input ('For which day of week you need data (saturday, sunday , monday ....friday): ')).lower()
...
def station_stats(df):
    ...
    df3 = pd.merge(df1 , df2 , how = 'outer' , on = ['combination'])
    print('the most common combination of start and end stations is: ' + str(df3.value_counts().idxmax()) + ' station.')
